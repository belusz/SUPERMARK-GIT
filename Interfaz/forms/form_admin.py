...
class AdminPanel:
    ...
    def __init__(self):
        self.ventana = tk.Tk()
        self.ventana.title("Sistema Supermark - Administrador")
        self.ventana.geometry('800x600')
        self.ventana.iconbitmap('./Interfaz/assets/frame2/carrito.ico')
        fondo = PhotoImage(file='./Interfaz/assets/frame2/super.gif')
        fondo = Label(self.ventana, image=fondo).place(x=0, y=0, relwidth=1,relheight=1 )
        menu1 = Menu(self.ventana)
